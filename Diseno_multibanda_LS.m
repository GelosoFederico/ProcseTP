...
f = [0 0.02092 0.0584 0.1140 0.1382 0.1726 0.2197 0.4325 0.4808 0.7067 0.8105 0.9575];

A = [2.297 2.321 0.3026 0.2951 3.74 3.727 0.575 0.595 1.26 1.33 1.845 4.014]; %Amplitudes para cada frecuencia de las que estan arriba
min_DW = 0.1;
...
M = 80; %Este parece el mejor por ahora 
